...
<div class="container">
  ...
  <div class="alert alert-success" role="alert">
    ...
    <hr>
    <p>“The saddest aspect of life right now is that science gathers knowledge faster than society gathers wisdom.”
    </p>

    <p class="mb-0">– Isaac Asimov</p>
  </div>
    ...
    <div class="col-lg-5">
      ...
      <div class="card my-5 py-4">
        ...
        <div class="card-footer">
          <a href="currentscience.html" class="btn btn-primary btn-block">More Info</a>
        </div>
      </div>
      ...
      <div class="card my-5 py-4">
        ...
        <div class="card-footer">
          <a href="login.html" class="btn btn-primary btn-block">Subscribe</a>
        </div>
      </div>
